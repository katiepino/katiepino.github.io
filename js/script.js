$(document).ready(function() {
  ...
  $(".portsumthree").html("This word cloud visualising Clinton's most frequently used words by size was created using the R programming language. Transcript from NYTimes.")
